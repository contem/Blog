...
class CommentCreate(APITestCase):
    ...
    def test_jwt_authentication(self):
        response = self.client.post(self.login_url, data={"username": "bugus1234", "password": "sifre1234"})
...
class CommentUpdateDeleteTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.post = Post.objects.create(title="deneme", content="içerik")
        self.user = User.objects.create_user(username=self.username, password=self.password)
        self.user2 = User.objects.create_user(username="bugus12345", password=self.password)
    ...
    def test_jwt_authentication(self, username="bugus1234", password="sifre1234"):
    ...
    def test_delete_other_user(self):
        self.test_jwt_authentication("bugus12345")
        response = self.client.delete(self.url)
